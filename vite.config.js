...
export default defineConfig({
  ...
  plugins: [{
    name: 'copy-assets',
    closeBundle() {
      // NOTE: Admin dashboard files (index.html, admin.js, admin.css) are
      // now handled entirely by Vite as entry points. Do NOT copy them raw
      // — that overwrites Vite-processed output and breaks import.meta.env.
